...
export class DataSeederService {
  ...
  //   {name: "ბასიანი", profilePictureUri: {uri: 'https://icons.iconarchive.com/icons/google/noto-emoji-activities/1024/52707-party-popper-icon.png'}},
  //   {name: "ბურგერ კინგი", profilePictureUri: {uri: 'https://cdn-icons-png.flaticon.com/512/198/198416.png'}},
  //   {name: "Holiday Inn", profilePictureUri: {uri: 'https://img.favpng.com/25/23/8/holiday-inn-moscow-png-favpng-LybQ9mA6tUc9LC4c4Qttp73pS.jpg'}},
  //   {name: "თუმანიშვილის თეატრი", profilePictureUri: {uri: 'https://lh3.googleusercontent.com/proxy/Lf0ZA6693XF9Dm5_6HBmc0ZjBEcWZtyWrvKsR7hfEEPA2ahCOnbHQ1h-rCDEBWtdKgD2OPdQirLx2Kgv5PYE31iSnHZSB5Oyu15ZjLw9XQwQscPHZvXjsHLYLiWEC_gL1AbrQNnWkwJHqynr-xgnuF8'}},
  //   {name: "კოჭლი ზურა", profilePictureUri: {uri: 'https://i.ytimg.com/vi/7Fz1Wpb3RYs/hqdefault.jpg'}},
  //
  // ];
  //
